...
def carregar_dados():
    dados = {
        ...
        "idade": [23, 35, 29, np.nan, 40, 27, 33],
        "cidade": ["SP", "RJ", "SP", "MG", "RJ", "MG", "SP"],
        "salario": [3000, 5000, 4000, 3500, np.nan, 2800, 5200],
